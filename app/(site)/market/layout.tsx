      ...
      <header className="sticky top-0  border-b bg-background px-4 lg:px-6 z-50">
        ...
        <nav className="flex h-14 items-center justify-between lg:h-[60px] md:px-0.5 max-w-[940px] mx-auto">
          ...
          <nav className="flex gap-4 md:gap-6">
            <Link href="/market" className="flex items-center font-light">
              {/* <Play2 className="h-6 w-6" /> */}
              <span className="text-muted-foreground text-sm">چشم انداز</span>
            </Link>
            <Link href="/market" className="flex items-center font-light">
              {/* <Play2 className="h-6 w-6" /> */}
              <span className="text-muted-foreground text-sm">تازه‌ها</span>
            </Link>
            {/* <Link href="/solutions/art" className="flex items-center font-light">
              <Play2 className="h-6 w-6" />
              <span className="text-muted-foreground text-sm">تجهیزات</span>
            </Link> */}
          </nav>
          <div className="w-[69px] hidden md:block"></div>
        </nav>
        {/* <DropdownMenu>
