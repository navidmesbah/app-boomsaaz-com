    ...
    <>
      <header className="sticky top-0 border-b bg-background px-4 lg:px-6 z-50">
        <nav className="items-center justify-between gap-4 h-14 lg:h-[60px] hidden md:flex">
          <Link href="/supplier" className="flex items-center gap-2 font-semibold">
        ...
        <nav className="flex items-center justify-between gap-4 h-14 px-4 lg:h-[60px] md:hidden">
          <Link
            href="/supplier"
            // className="shrink-0"
            className={pathname === "/supplier" ? "shrink-0 text-centert text-primary" : "shrink-0 text-centert"}
          >
          ...
          <Link
            ...
            className={pathname === "/supplier/order" ? "shrink-0 text-centert text-primary" : "shrink-0 text-centert"}
          >
          ...
          <Link
            href="/supplier/edit"
            // className="shrink-0"
            className={pathname === "/supplier/edit" ? "shrink-0 text-centert text-primary" : "shrink-0 text-centert"}
        ...
        <div className="hidden border-l bg-background md:block">
          <div className="flex h-full max-h-screen flex-col gap-2">
            ...
            <div className="flex h-8 items-center px-4 lg:px-6">
              {/* <Link href="/suppliers" className="flex items-center gap-2 font-semibold">
            ...
            <div className="flex-1">
              <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
                ...
                <Link
                  ...
                  // className="flex items-center gap-3 rounded-lg bg-muted px-3 py-2 text-primary transition-all hover:text-primary"
                  // className="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary"
                  className={pathname === "/supplier/order"
                    ? "flex items-center gap-3 rounded-lg px-3 py-2 text-primary transition-all hover:text-primary"
                    : "flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary"}
                >
                ...
                <Link
                  ...
                  // className="flex items-center gap-3 rounded-lg bg-muted px-3 py-2 text-primary transition-all hover:text-primary"
                  // className="flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary"
                  className={pathname === "/supplier/edit"
                    ? "flex items-center gap-3 rounded-lg px-3 py-2 text-primary transition-all hover:text-primary"
                    : "flex items-center gap-3 rounded-lg px-3 py-2 text-muted-foreground transition-all hover:text-primary"}
                >
