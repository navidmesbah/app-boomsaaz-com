            ...
            >
                ...
                <div className="relative z-40 p-8">
                    <motion.p
                        ...
                        className="text-white text-sm md:text-base font-medium font-sans text-right"
                    >
                        {card.category}
                    </motion.p>
                    <motion.p
                        layoutId={layout ? `title-${card.title}` : undefined}
                        className="text-white text-xl md:text-3xl font-semibold max-w-xs text-right [text-wrap:balance] font-sans mt-2"
                    >
                        {card.title}
                    </motion.p>
                </div>
