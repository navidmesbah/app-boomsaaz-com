...
export const ParallaxScroll = ({
  ...
  const translateFirst = useTransform(scrollYProgress, [0, 1], [1400, -400]);
  const translateSecond = useTransform(scrollYProgress, [0, 1], [0, 0]);
  const translateThird = useTransform(scrollYProgress, [0, 1], [1400, -400]);
  ...
  return (
    <div
      ...
      className={cn("items-start w-full bg-black overflow-y-hidden", className)}
      ref={gridRef}
    >
      <div
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-start  max-w-5xl mx-auto py-40 px-10"
        ref={gridRef}
      >
